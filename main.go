...
import (
	...
	myresourceclientset "github.com/Haybu/k8s/client/clientset/versioned"
	myresourceinformer_v1 "github.com/Haybu/k8s/client/informers/externalversions/myresource/v1"
)
