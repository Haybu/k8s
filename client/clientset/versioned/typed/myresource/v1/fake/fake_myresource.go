...
import (
	...
	myresourcev1 "github.com/Haybu/k8s/apis/myresource/v1"
...
type FakeMyResources struct {
	Fake *FakeAgilehandyV1
	ns   string
}

var myresourcesResource = schema.GroupVersionResource{Group: "agilehandy.com", Version: "v1", Resource: "myresources"}

var myresourcesKind = schema.GroupVersionKind{Group: "agilehandy.com", Version: "v1", Kind: "MyResource"}
...
func (c *FakeMyResources) UpdateStatus(ctx context.Context, myResource *myresourcev1.MyResource, opts v1.UpdateOptions) (*myresourcev1.MyResource, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(myresourcesResource, "status", c.ns, myResource), &myresourcev1.MyResource{})
