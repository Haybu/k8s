...
import (
	...
	versioned "github.com/Haybu/k8s/client/clientset/versioned"
	internalinterfaces "github.com/Haybu/k8s/client/informers/externalversions/internalinterfaces"
	v1 "github.com/Haybu/k8s/client/listers/myresource/v1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.AgilehandyV1().MyResources(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AgilehandyV1().MyResources(namespace).Watch(context.TODO(), options)
			},
		},
